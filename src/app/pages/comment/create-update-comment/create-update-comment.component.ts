...
@Component({
  selector: 'app-create-update-comment',
  templateUrl: './create-update-comment.component.html',
  styleUrls: ['./create-update-comment.component.scss']
})
export class CreateUpdateCommentComponent implements OnInit {
  litigation: any;
